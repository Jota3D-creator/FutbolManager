...
Esta versión evita problemas de compatibilidad con algunos navegadores móviles:
- Reemplaza `structuredClone`.
- Agrega fallback para `crypto.randomUUID`.
- Comprime fotos antes de guardarlas en localStorage.
- Migra datos guardados desde la v2 si existen.
